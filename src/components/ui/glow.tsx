...
>(({ className, variant, ...props }, ref) => (
  ...
  >
    <div
      className={cn(
        "absolute left-1/2 h-[256px] w-[55%] -translate-x-1/2 scale-[2.5] rounded-[50%] bg-[radial-gradient(ellipse_at_center,_hsla(var(--brand-foreground)/.5)_10%,_hsla(var(--brand-foreground)/0)_60%)] sm:h-[512px]",
